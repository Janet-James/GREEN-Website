...
function responsive(maxWidth) {
  if (maxWidth.matches) { 
    ...
    $("#productsec").hover(
        function () {
            // console.log("Hi11");
            var productActivePath = $('#productsec .tab-list .active img').attr("src");
            // console.log(productActivePath);
            $('#fixed-top .navbar-brand img').attr("src", productActivePath);
        }, function () {
            $('#fixed-top .navbar-brand img').attr("src", "dist/images/green-logo.png");
        }
    );
    
  }else{
    $(".product-sec .tab-1, .product-sec .tab-2, .product-sec .tab-3").click(function () {
        $('#fixed-top .navbar-brand img').attr("src", "dist/images/green-logo.png");
    });
 ...
 var maxWidth = window.matchMedia("(min-width: 1366px)");
...
setInterval(function () {
    ...
    if ($("#solution-rotate-animation").hasClass("layout-1")) {
        ...
        $(".block-2 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        ...
        $(".block-2 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-2.jpg");
        ...
        $(".block-3 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        ...
        $(".block-3 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-3.jpg");
        ...
        $(".block-4 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        ...
        $(".block-4 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-4.jpg");
        ...
        $(".block-5 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        ...
        $(".block-5 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-5.jpg");
        ...
        $(".block-6 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        ...
        $(".block-6 .zoom-ani").attr("src", "dist/images/solutions/solution-hover-6.jpg");
...
setInterval(function () {
    ...
    if ($("#solution-rotate-animation-2").hasClass("layout-1")) {
        ...
        $("#solution-rotate-animation-2 .image-1").fadeOut(300);
        setTimeout(function () {
            $("#solution-rotate-animation-2 .image-1 .solu-hover").attr("src", "dist/images/solutions/solution-hover-2.jpg");
            $("#solution-rotate-animation-2 .image-1 .solution-hover-img img").attr("src", "dist/images/solutions/solution-2.jpg");
            $("#solution-rotate-animation-2 .image-1 h4").text("AGRICULTURE");
        ...
        $("#solution-rotate-animation-2 .image-2 .solu-hover").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        $("#solution-rotate-animation-2 .image-2 .solution-hover-img img").attr("src", "dist/images/solutions/solution-1.jpg");
        $("#solution-rotate-animation-2 .image-2  h4").text("HOME");
    } else if ($("#solution-rotate-animation-2").hasClass("layout-2")) {
        $("#solution-rotate-animation-2").addClass("layout-3");
        $("#solution-rotate-animation-2").removeClass("layout-2");
        ...
        $("#solution-rotate-animation-2 .image-1").fadeOut(300);
        setTimeout(function () {
            $("#solution-rotate-animation-2 .image-1 .solu-hover").attr("src", "dist/images/solutions/solution-hover-3.jpg");
            $("#solution-rotate-animation-2 .image-1 .solution-hover-img img").attr("src", "dist/images/solutions/solution-3.jpg");
            $("#solution-rotate-animation-2 .image-1 h4").text("EDUCATION");
            // $(".solution-1-single-img").load(".solution-1-single-img");
        }, 300);
        setTimeout(function () {
        ...
        $("#solution-rotate-animation-2 .image-2 .solu-hover").attr("src", "dist/images/solutions/solution-hover-2.jpg");
        $("#solution-rotate-animation-2 .image-2 .solution-hover-img img").attr("src", "dist/images/solutions/solution-2.jpg");
        $("#solution-rotate-animation-2 .image-2  h4").text("AGRICULTURE");

        $("#solution-rotate-animation-2 .image-3 .solu-hover").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        $("#solution-rotate-animation-2 .image-3 .solution-hover-img img").attr("src", "dist/images/solutions/solution-1.jpg");
        $("#solution-rotate-animation-2 .image-3  h4").text("HOME");
    } else if ($("#solution-rotate-animation-2").hasClass("layout-3")) {
        $("#solution-rotate-animation-2").addClass("layout-4");
        $("#solution-rotate-animation-2").removeClass("layout-3");
        ...
        $("#solution-rotate-animation-2 .image-1").fadeOut(300);
        setTimeout(function () {
            $("#solution-rotate-animation-2 .image-1 .solu-hover").attr("src", "dist/images/solutions/solution-hover-4.jpg");
            $("#solution-rotate-animation-2 .image-1 .solution-hover-img img").attr("src", "dist/images/solutions/solution-4.jpg");
            $("#solution-rotate-animation-2 .image-1 h4").text("CORPORATES");
            // $(".solution-1-single-img").load(".solution-1-single-img");
        }, 300);
        setTimeout(function () {
        ...
        $("#solution-rotate-animation-2 .image-3 .solu-hover").attr("src", "dist/images/solutions/solution-hover-3.jpg");
        $("#solution-rotate-animation-2 .image-3 .solution-hover-img img").attr("src", "dist/images/solutions/solution-3.jpg");
        $("#solution-rotate-animation-2 .image-3  h4").text("EDUCATION");

        $("#solution-rotate-animation-2 .image-4 .solu-hover").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        $("#solution-rotate-animation-2 .image-4 .solution-hover-img img").attr("src", "dist/images/solutions/solution-1.jpg");
        $("#solution-rotate-animation-2 .image-4  h4").text("HOME");
    } else if ($("#solution-rotate-animation-2").hasClass("layout-4")) {
        $("#solution-rotate-animation-2").addClass("layout-5");
        $("#solution-rotate-animation-2").removeClass("layout-4");
        ...
        $("#solution-rotate-animation-2 .image-1").fadeOut(300);
        setTimeout(function () {
            $("#solution-rotate-animation-2 .image-1 .solu-hover").attr("src", "dist/images/solutions/solution-hover-5.jpg");
            $("#solution-rotate-animation-2 .image-1 .solution-hover-img img").attr("src", "dist/images/solutions/solution-5.jpg");
            $("#solution-rotate-animation-2 .image-1 h4").text("HEALTHCARE");
            // $(".solution-1-single-img").load(".solution-1-single-img");
        }, 300);
        setTimeout(function () {
        ...
        $("#solution-rotate-animation-2 .image-4 .solu-hover").attr("src", "dist/images/solutions/solution-hover-4.jpg");
        $("#solution-rotate-animation-2 .image-4 .solution-hover-img img").attr("src", "dist/images/solutions/solution-4.jpg");
        $("#solution-rotate-animation-2 .image-4  h4").text("CORPORATES");

        $("#solution-rotate-animation-2 .image-5 .solu-hover").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        $("#solution-rotate-animation-2 .image-5 .solution-hover-img img").attr("src", "dist/images/solutions/solution-1.jpg");
        $("#solution-rotate-animation-2 .image-5  h4").text("HOME");
    } else if ($("#solution-rotate-animation-2").hasClass("layout-5")) {
        $("#solution-rotate-animation-2").addClass("layout-6");
        $("#solution-rotate-animation-2").removeClass("layout-5");
        ...
        $("#solution-rotate-animation-2 .image-1").fadeOut(300);
        setTimeout(function () {
            $("#solution-rotate-animation-2 .image-1 .solu-hover").attr("src", "dist/images/solutions/solution-hover-6.jpg");
            $("#solution-rotate-animation-2 .image-1 .solution-hover-img img").attr("src", "dist/images/solutions/solution-6.jpg");
            $("#solution-rotate-animation-2 .image-1 h4").text("TELECOM");
            // $(".solution-1-single-img").load(".solution-1-single-img");
        }, 300);
        setTimeout(function () {
        ...
        $("#solution-rotate-animation-2 .image-5 .solu-hover").attr("src", "dist/images/solutions/solution-hover-5.jpg");
        $("#solution-rotate-animation-2 .image-5 .solution-hover-img img").attr("src", "dist/images/solutions/solution-5.jpg");
        $("#solution-rotate-animation-2 .image-5  h4").text("HEALTHCARE");

        $("#solution-rotate-animation-2 .image-6 .solu-hover").attr("src", "dist/images/solutions/solution-hover-1.jpg");
        $("#solution-rotate-animation-2 .image-6 .solution-hover-img img").attr("src", "dist/images/solutions/solution-1.jpg");
        $("#solution-rotate-animation-2 .image-6  h4").text("HOME");
    } else if ($("#solution-rotate-animation-2").hasClass("layout-6")) {
        $("#solution-rotate-animation-2").addClass("layout-1");
        $("#solution-rotate-animation-2").removeClass("layout-6");
        ...
        $("#solution-rotate-animation-2 .image-1").fadeOut(300);
        setTimeout(function () {
            $("#solution-rotate-animation-2 .image-1 .solu-hover").attr("src", "dist/images/solutions/solution-hover-1.jpg");
            $("#solution-rotate-animation-2 .image-1 .solution-hover-img img").attr("src", "dist/images/solutions/solution-1.jpg");
            $("#solution-rotate-animation-2 .image-1 h4").text("HOME");
            // $(".solution-1-single-img").load(".solution-1-single-img");
        }, 300);
        setTimeout(function () {
        ...
        $("#solution-rotate-animation-2 .image-6 .solu-hover").attr("src", "dist/images/solutions/solution-hover-6.jpg");
        $("#solution-rotate-animation-2 .image-6 .solution-hover-img img").attr("src", "dist/images/solutions/solution-6.jpg");
        $("#solution-rotate-animation-2 .image-6  h4").text("TELECOM");
...
setInterval(function () {
    if ($(".solution-7 .solution-bg-main ").hasClass("layout-1")) {
        ...
        $(".solution-7 .solution-bg-main .main").attr("style", "background: url('dist/images/solutions/solution-2.jpg') no-repeat center; background-size: cover;");
        ...
        $(".solution-7 .solution-bg-main .main").attr("style", "background: url('dist/images/solutions/solution-3.jpg') no-repeat center; background-size: cover;");
        ...
        $(".solution-7 .solution-bg-main .main").attr("style", "background: url('dist/images/solutions/solution-4.jpg') no-repeat center; background-size: cover;");
        ...
        $(".solution-7 .solution-bg-main .main").attr("style", "background: url('dist/images/solutions/solution-5.jpg') no-repeat center; background-size: cover;");
        ...
        $(".solution-7 .solution-bg-main .main").attr("style", "background: url('dist/images/solutions/solution-6.jpg') no-repeat center; background-size: cover;");
        ...
        $(".solution-7 .solution-bg-main .main").attr("style", "background: url('dist/images/solutions/solution-1.jpg') no-repeat center; background-size: cover;");
...
$(document).ready(function () {   
    ...
    $(".solution-4-single-img").hover(function () {
        ...
        $(".solution-4").attr("style", "background: url('" + soluImg + "') no-repeat center;background-size: cover;");
    ...
    setInterval(function () {
        ...
        if($(".sunshine01").hasClass("active")) {
            ...
            if($(".product-sunshine-details-title").hasClass("product-sunshine-detail-show")) {
    ...
    $('.onProductsunsmart01').click(function () {
      ...
      $('.backToProductsunsmart').click(function () {
        ...
        $('.product-sunsmart-details-title').removeClass('product-sunsmart-detail-show');
      ...
      setInterval(function () {
        ...
        if($(".sunsmart01").hasClass("active")) {
            ...
            if($(".product-sunsmart-details-title").hasClass("product-sunsmart-detail-show")) {
      ...
      $('.onProductSunempawa01').click(function () {
        ...
        $('.product-sunempawa-details-01').addClass('product-sunempawa-detail-show');
        $(this).addClass('d-none');
      });
      ...
      $('.onProductSunempawa02').click(function () {
        ...
        $('.sunempawa-slider02 , .sunempawa-slider03').addClass('d-none');
        $('.backToProductSunempawa').removeClass('d-none');
        $('.product-sunempawa-details-02').addClass('product-sunempawa-detail-show');
        $(this).addClass('d-none');
      });
      $('.onProductSunempawa03').click(function () {
        ...
        $('.sunempawa-slider02 , .sunempawa-slider03').addClass('d-none');
        $('.backToProductSunempawa').removeClass('d-none');
        $('.product-sunempawa-details-03').addClass('product-sunempawa-detail-show');
        $(this).addClass('d-none');
      });
      $('.onProductSunempawa04').click(function () {
        ...
        $('.sunempawa-slider02 , .sunempawa-slider03').addClass('d-none');
        $('.backToProductSunempawa').removeClass('d-none');
        $('.product-sunempawa-details-04').addClass('product-sunempawa-detail-show');
        $(this).addClass('d-none');
      });
      $('.onProductSunempawa05').click(function () {
        ...
        $('.sunempawa-slider02 , .sunempawa-slider03').addClass('d-none');
        $('.backToProductSunempawa').removeClass('d-none');
        $('.product-sunempawa-details-05').addClass('product-sunempawa-detail-show');
        $(this).addClass('d-none');
      });
      $('.onProductSunempawa06').click(function () {
        ...
        $('.sunempawa-slider02 , .sunempawa-slider03').addClass('d-none');
        $('.backToProductSunempawa').removeClass('d-none');
        $('.product-sunempawa-details-06').addClass('product-sunempawa-detail-show');
        $(this).addClass('d-none');
      });
    
      $('.backToProductSunempawa').click(function () {
        $('.product-sunempawa-detail-show').addClass('d-none');
        $('.product-sunempawa-details-title').removeClass('product-sunempawa-detail-show');
      ...
      setInterval(function () {
        ...
        if($(".sunempawa01").hasClass("active")) {
            ...
            if($(".product-sunempawa-details-title").hasClass("product-sunempawa-detail-show")) {
    ...
    $('.ServiceSevenCategory button').click(function () {
        ...
        $(this).addClass('active');
        $('.ServiceSevenCategory button img').attr('src', 'dist/images/services/d7/arrow_right_blk.png');
        $(this).children('img').attr('src', 'dist/images/services/d7/arrow_right_grn.png');
        if($(this).hasClass("onSlideService01")){
            $(".service-arrow").removeClass("onService01  onService02  onService03 onService04");
    ...
    $('.service-arrow').click(function () {
            $('.mainService, .single-service-main-title, .single-service-details').removeClass('show');
            $('.tab-service button').removeClass('active');
            $('.service-detail').addClass('show');

        if($(this).hasClass("onService01")){
            $('.single-service-details.service-1, .single-service-main-title.service-1 ').addClass('show');
            $('.tab-service .service-1').addClass('active');        
        }else if($(this).hasClass("onService02")){
            $('.single-service-details.service-2, .single-service-main-title.service-2 ').addClass('show');
            $('.tab-service .service-2').addClass('active');          
        }else if($(this).hasClass("onService03")){
            $('.single-service-details.service-3, .single-service-main-title.service-3 ').addClass('show');
            $('.tab-service .service-3').addClass('active');           
        }else if($(this).hasClass("onService04")){
            $('.single-service-details.service-4, .single-service-main-title.service-4 ').addClass('show');
    ...
    $('.service-arrow-back').click(function () {   
        ...
        $('#ServiceSevenTitleCarousal .carousel-item, #ServiceSevenImgCarousal  .carousel-item, #ServiceSevenImgTwoCarousal .carousel-item, .ServiceSevenCategory button').removeClass('active');

        if($(this).hasClass("backToService01")){
            $('#ServiceSevenTitleCarousal .item-1, #ServiceSevenImgCarousal  .item-1, #ServiceSevenImgTwoCarousal .item-1, .ServiceSevenCategory .onSlideService01').addClass('active');       
        }else if($(this).hasClass("backToService02")){
            $('#ServiceSevenTitleCarousal .item-2, #ServiceSevenImgCarousal  .item-2, #ServiceSevenImgTwoCarousal .item-2, .ServiceSevenCategory .onSlideService02').addClass('active');           
        }else if($(this).hasClass("backToService03")){
            $('#ServiceSevenTitleCarousal .item-3, #ServiceSevenImgCarousal  .item-3, #ServiceSevenImgTwoCarousal .item-3, .ServiceSevenCategory .onSlideService03').addClass('active');             
        }else if($(this).hasClass("backToService04")){
            $('#ServiceSevenTitleCarousal .item-4, #ServiceSevenImgCarousal  .item-4, #ServiceSevenImgTwoCarousal .item-4, .ServiceSevenCategory .onSlideService04').addClass('active');      
        }
    });
    ...
    $('.tab-service button').click(function () {
        $(".single-service-details, .single-service-main-title").removeClass("show");
        $(".tab-service button").removeClass("active");
    ...
    $('.service-1 .service-item').hover(function () {
        if($(this).hasClass("item-1")){
            $('.engineering-img img').attr("src", "dist/images/services/engg_details_page_images/item-1.png")
           
        }else if($(this).hasClass("item-2")){
            $('.engineering-img img').attr("src", "dist/images/services/engg_details_page_images/item-2.png")
        }
        else if($(this).hasClass("item-3")){
            $('.engineering-img img').attr("src", "dist/images/services/engg_details_page_images/item-3.png")
        }
        else if($(this).hasClass("item-4")){
            $('.engineering-img img').attr("src", "dist/images/services/engg_details_page_images/item-4.png")
        }
        else if($(this).hasClass("item-5")){
            $('.engineering-img img').attr("src", "dist/images/services/engg_details_page_images/item-5.png")
        }
        // console.log('hover');
    });

    $('.service-1 .service-item').mouseleave(function () {        
        $('.engineering-img img').attr("src", "dist/images/services/d7/02Jun_Artboard_1.png")
    });


    $('.service-2 .service-item').hover(function () {
        if($(this).hasClass("item-1")){
            $('.engineering-img img').attr("src", "dist/images/services/procurement_details_page_images/item-1.jpg")
            
        }
    });

    $('.service-2 .service-item').mouseleave(function () {        
        $('.engineering-img img').attr("src", "dist/images/services/d7/02Jun_Artboard_2.png")
    });


    $('.service-3 .service-item').hover(function () {
        if($(this).hasClass("item-1")){
            $('.engineering-img img').attr("src", "dist/images/services/construction_details_page_images/item-1.jpg")
            
        }else if($(this).hasClass("item-2")){
            $('.engineering-img img').attr("src", "dist/images/services/construction_details_page_images/item-2.jpg")
        }
        else if($(this).hasClass("item-3")){
            $('.engineering-img img').attr("src", "dist/images/services/construction_details_page_images/item-3.jpg")
        }
        else if($(this).hasClass("item-4")){
            $('.engineering-img img').attr("src", "dist/images/services/construction_details_page_images/item-4.jpg")
        }
    });
    ...
    $('.onSolutionDetail').click(function () {
        if ($('.onSolutionDetail').hasClass('back')) {
            ...
            // button animation
            $('.onSolutionDetail .text').attr('src', 'dist/images/solutions/icons/explore.png');
            ...
            // button animation
            $('.onSolutionDetail .text').attr('src', 'dist/images/solutions/icons/back.png');
            ...
            $('.solution-bg-main').removeClass('layout-1 , layout-2 , layout-3 , layout-4 , layout-5 , layout-6');
    ...
    setInterval(function () {
        //News feed 
        if ($(".product .flip-card-front").hasClass("active")) {
          setTimeout(function () {
            $(".product .flip-card-inner").css("transform", "rotateY(180deg)");
            $(".product .flip-card-front").removeClass("active");
            $(".product .flip-card-back").addClass("active");
          }, 1000);
        }
      
        if ($(".product .flip-card-back").hasClass("active")) {
            setTimeout(function () {
              $(".product .flip-card-inner").css("transform", "rotateY(0deg)");
              $(".product .flip-card-back").removeClass("active");
              $(".product .flip-card-front").addClass("active");
            }, 1000);
          }
      }, 7000);
      ...
      setInterval(function () {
        //News feed 
        if ($(".product1 .flip-card-front").hasClass("active")) {
          setTimeout(function () {
            $(".product1 .flip-card-inner").css("transform", "rotateY(180deg)");
            $(".product1 .flip-card-front").removeClass("active");
            $(".product1 .flip-card-back").addClass("active");
          }, 1000);
        }
      
        if ($(".product1 .flip-card-back").hasClass("active")) {
            setTimeout(function () {
              $(".product1 .flip-card-inner").css("transform", "rotateY(0deg)");
              $(".product1 .flip-card-back").removeClass("active");
              $(".product1 .flip-card-front").addClass("active");
            }, 1000);
          }
      }, 10000);
      ...
      setInterval(function () {
        //News feed 
        if ($(".product2 .flip-card-front").hasClass("active")) {
          setTimeout(function () {
            $(".product2 .flip-card-inner").css("transform", "rotateY(180deg)");
            $(".product2 .flip-card-front").removeClass("active");
            $(".product2 .flip-card-back").addClass("active");
          }, 1000);
        }
      
        if ($(".product2 .flip-card-back").hasClass("active")) {
            setTimeout(function () {
              $(".product2 .flip-card-inner").css("transform", "rotateY(0deg)");
              $(".product2 .flip-card-back").removeClass("active");
              $(".product2 .flip-card-front").addClass("active");
            }, 1000);
          }
      }, 13000);
